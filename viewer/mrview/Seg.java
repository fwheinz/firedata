...
//        this.e = e;
    ...
    public MSeg2 move(Point vector) {
        return new MSeg2(new Seg(this), new Seg(this).translate(vector));
    }
...
//        return i1;
    ...
    public void printGraph(String prefix, int linestyle, int i) {
        String x = "" + s.x + "+(" + (e.x - s.x) + ")*t";
        String y = "" + s.y + "+(" + (e.y - s.y) + ")*t";
        if (i > 0) {
            Plot.plot(prefix + i, x, y, linestyle);
        } else {
